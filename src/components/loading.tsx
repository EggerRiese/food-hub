    ...
    return (
      <div role="status" className="inline-block">
        <svg aria-hidden="true"
          className="animate-spin fill-blue-500 text-slate-200 dark:text-blue-700"
          viewBox="0 0 100 101"
          fill="none"
        ...
        <div className="flex flex-row items-center order-last">
          <div>
            <div className="flex flex-initial flex-row gap-6 text-right border-t-4 pt-2">
              <div className="menu-entry"><a>Food</a></div>
              <div className="menu-entry"><a>Help</a></div>
              <div className="menu-entry"><a>Add</a></div>
              <div className="menu-entry">Sign out</div>
            </div>
          </div> 
        </div>
      </div>
